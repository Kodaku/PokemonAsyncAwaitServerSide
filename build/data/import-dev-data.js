...
var pokeBallDB_1 = require("../src/database/pokeBallDB");
...
if (process.env.DATABASE_PASSWORD && process.env.DATABASE) {
    ...
    //READ JSON FILE
    var pokemons_1 = JSON.parse(fs_1.default.readFileSync(__dirname + "/pokeBall.json", 'utf-8'));
    //IMPORT DATA INTO DB
    var importData = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, pokeBallDB_1.PokeBall.create(pokemons_1)];
                case 1:
                    _a.sent();
    ...
    var deleteData = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, pokeBallDB_1.PokeBall.deleteMany({})];
                case 1:
                    _a.sent();

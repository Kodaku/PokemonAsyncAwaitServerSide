...
exports.notifyRestart = exports.notifyScreenChange = exports.restartPlay = exports.requireScreenChange = void 0;
var shouldShowMenu = [false, false, false, false];
var completeShowMenu = [false, false, false, false];
var shouldRestartPlay = [false, false, false, false];
var completeRestartPlay = [false, false, false, false];
exports.requireScreenChange = function (req, res) {
...
exports.restartPlay = function (req, res) {
    var id = parseInt(req.params.id);
...
exports.notifyScreenChange = function (req, res) {
...
exports.notifyRestart = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var id;
        return __generator(this, function (_a) {
            switch (_a.label) {

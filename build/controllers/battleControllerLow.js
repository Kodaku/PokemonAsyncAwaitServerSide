...
exports.getUserIntroNotification = exports.postUserIntroNotification = void 0;
var usersIntroNotifications = [false, false];
// let usersIntroNotificationsMessages: string[] = ['', ''];
exports.postUserIntroNotification = function (req, res) {
    var id = parseInt(req.params.id);
    usersIntroNotifications[id] = true;
    //   usersIntroNotificationsMessages[id] = 'DONE';
    res.status(200).json({
        status: 'success',
        data: usersIntroNotifications,
    });
};
exports.getUserIntroNotification = function (req, res) {
